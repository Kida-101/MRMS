    ...
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-primary-100 flex items-center justify-center bg-gray-100">
      <div className="bg-white rounded-2xl shadow-xl p-8 space-y-6 w-100">
        <div className="text-center space-y-2">
          <Image
            className="w-30 h-30 rounded-full border mx-auto"
            src="https://img.freepik.com/free-vector/indonesian-halal-logo-new-branding-2022_17005-1495.jpg?t=st=1742808628~exp=1742812228~hmac=efcd718ff4a52a58e694a812c937e1bd61fe426b07204662dbe7e011958e227e&w=740"
            alt="Logo"
          />
